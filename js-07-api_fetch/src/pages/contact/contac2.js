...
import { insertMainHeader } from "../../modules/header/header";


// De forma alternativa para tener un codigo de tener algo asincrono se usa async y await
...
console.log("Msj 2");
 ...
 //  ================ uso de la API fetch ===========================
 // sirve para hacer peticiones de tipo HTTP (GET, POST, DELETE, PUT)
// ============== Uso de la api fetch ====================  Te devuelve una promesa 
